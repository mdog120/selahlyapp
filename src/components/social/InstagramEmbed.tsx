...
// Curated aesthetic Unsplash images representing Selahly vibes.
// IMPORTANT: Please replace these `postUrl` and `imageUrl` values with the actual 
// links and images of the posts published on your Instagram account!
const INSTAGRAM_POSTS = [
    {
        id: "1",
        imageUrl: "https://images.unsplash.com/photo-1507434965515-61970f2bd7c6?q=80&w=400&auto=format&fit=crop",
        postUrl: "https://www.instagram.com/selahlyapp/", // Replace with actual post permalink, e.g., https://www.instagram.com/p/C7X3_o7yS8D/
        likes: 124,
        comments: 18,
    },
    {
        ...
        postUrl: "https://www.instagram.com/selahlyapp/",
        likes: 98,
        comments: 12,
    },
    {
